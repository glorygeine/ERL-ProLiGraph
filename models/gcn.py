...
class GCNNet(torch.nn.Module):
    def __init__(self, n_output=1, num_features_pro=54, num_features_lig=78, output_dim=128, dropout=0.2):
        ...
        self.lig_c1 = GCNConv(num_features_lig, num_features_lig)
        self.lig_c2 = GCNConv(num_features_lig, num_features_lig * 2)
        ...
        self.pro_c1 = GCNConv(num_features_pro, num_features_pro)
        self.pro_c2 = GCNConv(num_features_pro, num_features_pro * 2)
