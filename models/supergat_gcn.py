...
# SuperGAT_GCN Model
class SuperGAT_GCN(torch.nn.Module):
    def __init__(self, n_output=1, num_features_pro=54, num_features_lig=78, output_dim=128, dropout=0.2):
        super(SuperGAT_GCN, self).__init__()

        print('SuperGAT_GCN Loaded')
        self.n_output = n_output
        self.lig_c1 = SuperGATConv(num_features_lig, num_features_lig)
        self.lig_c2 = SuperGATConv(num_features_lig, num_features_lig * 2)
        self.lig_c3 = GCNConv(num_features_lig * 2, num_features_lig * 4)
        self.lig_fc_g1 = torch.nn.Linear(num_features_lig * 4, 1024)
        self.lig_fc_g2 = torch.nn.Linear(1024, output_dim)

        self.pro_c1 = SuperGATConv(num_features_pro, num_features_pro)
        self.pro_c2 = SuperGATConv(num_features_pro, num_features_pro * 2)
        self.pro_c3 = GCNConv(num_features_pro * 2, num_features_pro * 4)
